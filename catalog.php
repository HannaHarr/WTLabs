<?php
	...
	$data = $pdo->query('SELECT * FROM announcements')->fetchAll();
	...
	$arrayTemplate['content'] = file_get_contents($arrayFileTemplates['catalog']);
	$arrayTemplate['announcement'] = expandArray($data, $arrayFileTemplates['announcement']);
